...
class Overlap360Group(QGroupBox):
    ...
    def help_button_pressed(self):
        ...
        h = (
            "This script takes as input a CT scan that has been collected in 'half-acquisition'"
            " mode"
        )
        h += (
            " and produces a series of reconstructed slices, each of which are generated by"
            " cropping and"
        )
        h += (
            " concatenating opposing projections together over a range of 'overlap' values (i.e."
            " the pixel column"
        )
        h += " at which the images are cropped and concatenated)."
        h += (
            " The objective is to review this series of images to determine the pixel column at"
            " which the axis of rotation"
        )
        h += (
            " is located (much like the axis search function commonly used in reconstruction"
            " software)."
        )
