...
class NLMDNGroup(QGroupBox):
    ...
    def set_apply_to_reco(self):
        ...
        parameters.params["e_nlmdn_apply_after_reco"] = bool(
    ...
    def apply_button_pressed(self):
        ...
        args = tk_args(
            ...
            parameters.params["e_nlmdn_indir"],
            parameters.params["e_nlmdn_input_is_file"],
            parameters.params["e_nlmdn_outdir"],
            parameters.params["e_nlmdn_bigtif"],
            parameters.params["e_nlmdn_r"],
            parameters.params["e_nlmdn_dx"],
            parameters.params["e_nlmdn_h"],
            parameters.params["e_nlmdn_sig"],
            parameters.params["e_nlmdn_w"],
            parameters.params["e_nlmdn_fast"],
            parameters.params["e_nlmdn_autosig"],
            parameters.params["e_nlmdn_dryrun"],
        )
        LOG.debug(args.args)
