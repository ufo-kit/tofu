...
class ConfigGroup(QGroupBox):
    ...
    def reco_button_pressed(self):
        ...
        try:
            ...
            args = tk_args(
                parameters.params["e_indir"],
                parameters.params["e_tmpdir"],
                parameters.params["e_outdir"],
                parameters.params["e_bigtif"],
                parameters.params["e_ax"],
                parameters.params["e_ax_range"],
                parameters.params["e_ax_row"],
                parameters.params["e_ax_p_size"],
                parameters.params["e_ax_fix"],
                parameters.params["e_dax"],
                parameters.params["e_inp"],
                parameters.params["e_inp_thr"],
                parameters.params["e_inp_sig"],
                parameters.params["e_RR"],
                parameters.params["e_RR_ufo"],
                parameters.params["e_RR_ufo_1d"],
                parameters.params["e_RR_par"],
                parameters.params["e_rr_srp_wind_sort"],
                parameters.params["e_rr_srp_wide"],
                parameters.params["e_rr_srp_wind_wide"],
                parameters.params["e_rr_srp_snr"],
                parameters.params["e_PR"],
                parameters.params["e_energy"],
                parameters.params["e_pixel"],
                parameters.params["e_z"],
                parameters.params["e_log10db"],
                parameters.params["e_vcrop"],
                parameters.params["e_y"],
                parameters.params["e_yheight"],
                parameters.params["e_ystep"],
                parameters.params["e_gray256"],
                parameters.params["e_bit"],
                parameters.params["e_hmin"],
                parameters.params["e_hmax"],
                parameters.params["e_pre"],
                parameters.params["e_pre_cmd"],
                parameters.params["e_a0"],
                parameters.params["e_crop"],
                parameters.params["e_x0"],
                parameters.params["e_dx"],
                parameters.params["e_y0"],
                parameters.params["e_dy"],
                parameters.params["e_dryrun"],
                parameters.params["e_parfile"],
                parameters.params["e_keep_tmp"],
            )
    ...
    def validate_input(self):
        ...
        if int(parameters.params["e_inp_thr"]) < 0:
            raise InvalidInputError(
                "Value out of range for: Threshold (prominence of the spot) [counts]"
            )
        ...
        if int(parameters.params["e_log10db"]) < 0:
            raise InvalidInputError(
                "Value out of range for: Delta/beta ratio: (try default if unsure)"
            )
        ...
        if float(parameters.params["e_a0"]) < 0:
            raise InvalidInputError(
                "Value out of range for: Optional: rotate volume clock by [deg]"
            )
